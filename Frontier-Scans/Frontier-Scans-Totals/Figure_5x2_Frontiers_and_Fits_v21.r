...
load_US_totals <- function() {
  # Use breakdown file with per-Games medal counts
  df <- sanitize_names(read.csv("ATHLETES_USA_SWIMMERS_breakdown.csv", check.names = TRUE))
  # Sum across all Games columns: X1896.Summer, X1900.Summer, X1924.Winter, etc.
...
ggsave("Figure_5x2_Frontiers_and_Fits_TOTALS_v21.pdf",
